...
export default function Footer(){
    return(
        <div className="flex justify-around text-white py-10 sm:py-14 border-t-1 border-white">
            ...
            <ul className="flex flex-col justify-around gap-1">
                ...
                <li>
                    <ul className="flex flex-row justify-around items-center gap-5 sm:gap-10">
                        <li><Link href={"#add facebook Link"} target="_blank" rel="noopener noreferrer"><i className="fa fa-facebook-square hover:text-gray-400 transition duration-200 ease-in-out" style={{fontSize:"20px", color:"white"}}></i></Link></li>
                        <li><Link href={"#add twitter Link"} target="_blank" rel="noopener noreferrer"><i className="fa fa-twitter hover:text-gray-400 transition duration-200 ease-in-out" style={{fontSize:"20px"}}></i></Link></li>
                        <li><Link href={"#add instagram Link"} target="_blank" rel="noopener noreferrer"><i className="fa fa-linkedin-square hover:text-gray-400 transition duration-200 ease-in-out" style={{fontSize:"20px"}}></i></Link></li>
                    </ul>
                </li>
            </ul>
        </div>
