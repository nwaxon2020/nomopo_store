    ...
    return(
        <div className="py-4 sm:p-8">
            <div className="max-w-6xl mx-auto px-4 my-6 py-8 bg-gray-300 ">
                ...
                <p className="text-base text-gray-700 mb-4 my-2">Here at <strong className="text-red-600 font-extrabold underline border-3 inline rounded-md px-1 border-l-[goldenrod]"><Link href={"/"}>Nomo<span className="text-[goldenrod] underline">Po</span></Link></strong> <strong>Stores</strong>, We value your privacy and are committed to protecting any personal information you share with us. This Privacy Policy outlines the types of information we collect, how we use it, and how we protect your data when you use our website <a href="https://nomophonez.vercel.app" className="text-blue-600 hover:underline">https://nomophonez.vercel.app</a>.</p>
                ...
                <p className="text-base text-gray-700 mb-4">We use the <strong>Google</strong> and <strong>Facebook</strong> services to help you understand our works from other Plateforms hense no info of yours is shared with us.</p>
                ...
                <p className="text-base text-gray-700 mb-4">Since we do not store your data, there is no need for explicit data deletion. However, if you wish to revoke permissions recieving emails from us, Please use your provided email and Unsubscribe.</p>
            
                <h3 className="text-l font-semibold text-gray-800 mb-2">7. Security</h3>
                <p className="text-base text-gray-700 mb-6">We take reasonable steps to protect your information from unauthorized access or disclosure. However, as we do not store sensitive data, the responsibility for securing your personal data lies with the third-party services (Payment services) that authenticate you.</p>
